import AJA_FANTASY from "../../assets/fanm-fantasy-badges/AJA.png";
import ARS_FANTASY from "../../assets/fanm-fantasy-badges/ARS.png";
import ATM_FANTASY from "../../assets/fanm-fantasy-badges/ATM.png";
import BAR_FANTASY from "../../assets/fanm-fantasy-badges/BAR.png";
import BAY_FANTASY from "../../assets/fanm-fantasy-badges/BAY.png";
import BEN_FANTASY from "../../assets/fanm-fantasy-badges/BEN.png";
import CHE_FANTASY from "../../assets/fanm-fantasy-badges/CHE.png";
import DOR_FANTASY from "../../assets/fanm-fantasy-badges/DOR.png";
import INT_FANTASY from "../../assets/fanm-fantasy-badges/INT.png";
import KAI_FANTASY from "../../assets/fanm-fantasy-badges/KAI.png";
import LIV_FANTASY from "../../assets/fanm-fantasy-badges/LIV.png";
import MAR_FANTASY from "../../assets/fanm-fantasy-badges/MAR.png";
import MCI_FANTASY from "../../assets/fanm-fantasy-badges/MCI.png";
import MIL_FANTASY from "../../assets/fanm-fantasy-badges/MIL.png";
import MUN_FANTASY from "../../assets/fanm-fantasy-badges/MUN.png";
import NAP_FANTASY from "../../assets/fanm-fantasy-badges/NAP.png";
import NEW_FANTASY from "../../assets/fanm-fantasy-badges/NEW.png";
import PIR_FANTASY from "../../assets/fanm-fantasy-badges/PIR.png";
import POR_FANTASY from "../../assets/fanm-fantasy-badges/POR.png";
import PSG_FANTASY from "../../assets/fanm-fantasy-badges/PSG.png";
import PSV_FANTASY from "../../assets/fanm-fantasy-badges/PSV.png";
import RMA_FANTASY from "../../assets/fanm-fantasy-badges/RMA.png";
import SUN_FANTASY from "../../assets/fanm-fantasy-badges/SUN.png";
import TOT_FANTASY from "../../assets/fanm-fantasy-badges/TOT.png";

const FANM_FANTASY_BADGES = {
  AJA: AJA_FANTASY,
  ARS: ARS_FANTASY,
  ATM: ATM_FANTASY,
  BAR: BAR_FANTASY,
...
export const FANM_PRO_CLUBS = [
  ...
  { type: "club", abbr: "ATM", name: "Atlético Madrid", leagueGroup: "LaLiga", logo32: "" },
  ...
  { type: "club", abbr: "SUN", name: "Mamelodi Sundowns", leagueGroup: "PSL", logo32: "" },
  { type: "club", abbr: "PIR", name: "Orlando Pirates", leagueGroup: "PSL", logo32: "" },
  { type: "club", abbr: "KAI", name: "Kaizer Chiefs", leagueGroup: "PSL", logo32: "" },
].map((team) => ({
  ...team,

  /*
   * V4 Fantasy-5 artwork is now canonical throughout FANM.
   * Preserve the former professional crest path for rollback only.
   */
  originalLogo32: team.logo32 || "",
  fantasyLogo32:
    FANM_FANTASY_BADGES[team.abbr] || team.logo32 || "",
  logo32:
    FANM_FANTASY_BADGES[team.abbr] || team.logo32 || "",
}));
