 ...
 */
// src/components/HomePage_HUB/HomePage_HUB_VenueProfileEditorModal.jsx
...
function getDraftFromClub(club = {}, adminIdentity = {}) {
  ...
  return {
    ...
    latitude: source?.locationDetails?.latitude ?? source.latitude ?? source?.geo?.lat ?? null,
...
export default function HomePage_HUB_VenueProfileEditorModal({
  club,
  isOpen,
  onClose,
  onSaved,
