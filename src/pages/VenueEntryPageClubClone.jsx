 ...
 */
// src/pages/VenueEntryPageClubClone.jsx
...
async function findExistingPhotoDataByIdentity(identityLike, clubId = DEFAULT_CLUB_ID) {
  ...
  for (const id of ids) {
    try {
      ...
      console.error("[VenueEntryPageClubClone] Failed checking player photo:", err);
    }
  }
...
async function upsertPlayerFromMember(member, clubId = DEFAULT_CLUB_ID) {
  ...
  if (!displayName) {
    console.warn("[VenueEntryPageClubClone] upsertPlayerFromMember: empty name, skipping");
    return null;
  }
  ...
  try {
    ...
    console.error(
      "[VenueEntryPageClubClone] Failed to sync member into players collection:",
      err
    );
    return null;
  }
...
async function resolveSignedInRoleFromPlayerDoc(member, emailFromGoogle = "", clubId = DEFAULT_CLUB_ID) {
  ...
  for (const pid of candidateIds) {
    try {
      ...
      console.error("[VenueEntryPageClubClone] Failed reading player role:", err);
    }
  }
...
async function clearWithdrawnPlayerPrivateDetails({ clubId = DEFAULT_CLUB_ID, memberId = "", playerId = "" }) {
  ...
  if (playerId) {
    try {
      ...
      console.error("[VenueEntryPageClubClone] Could not clear player contact details:", err);
    }
  }
}

export function VenueEntryPageClubClone({
  identity,
  selectedClub,
  ...
  useEffect(() => {
    ...
    const unsub = onSnapshot(
      ...
      (error) => {
        console.error("[VenueEntryPageClubClone] Could not load latest club profile:", error);
      }
    );
  ...
  useEffect(() => {
    ...
    const unsub = onSnapshot(
      ...
      (snap) => {
        ...
        console.log(
          "[VenueEntryPageClubClone] Loaded members for",
          activeClubId,
          list.map((m) => ({
            id: m.id,
            fullName: m.fullName,
  ...
  const handleProfilePhotoChange = async (event) => {
    ...
    try {
      ...
      console.error("[VenueEntryPageClubClone] Could not prepare profile photo:", error);
  ...
  const handleSavePlayerProfile = async () => {
    ...
    try {
      ...
      console.error("[VenueEntryPageClubClone] Could not update profile:", error);
      ...
      try {
        ...
        if (playerId) {
          try {
            ...
            console.warn(
              "[VenueEntryPageClubClone] Identity audit could not read player profile:",
              error
            );
          }
        }
        ...
        async function countMatchingDocuments(collectionName, matches) {
          ...
          for (const [fieldName, fieldValue] of matches) {
            ...
            try {
              ...
              console.warn(
                `[VenueEntryPageClubClone] Identity audit could not query ${collectionName}.${fieldName}:`,
                error
              );
            }
          }
        ...
        console.error(
          "[VenueEntryPageClubClone] Identity Safety Audit failed:",
          error
        );
  ...
  const handleClubHeroPhotoChange = async (e) => {
    ...
    try {
      ...
      console.error("[VenueEntryPageClubClone] Failed updating club hero photo:", err);
  ...
  const handleNewPhotoChange = async (e) => {
    ...
    try {
      ...
      console.error("[VenueEntryPageClubClone] Failed preparing request photo:", err);
  ...
  const handleReminderPhotoChange = async (e) => {
    ...
    try {
      ...
      console.error("[VenueEntryPageClubClone] Failed preparing reminder photo:", err);
  ...
  const handleSaveReminderPhoto = async () => {
    ...
    try {
      ...
      console.error("[VenueEntryPageClubClone] Failed saving reminder photo:", err);
  ...
  const handleSaveWhatsAppReminder = async () => {
    ...
    try {
      ...
      console.error("[VenueEntryPageClubClone] Failed saving WhatsApp number:", err);
  ...
  const handleSubmitWithdrawalRequest = async () => {
    ...
    try {
      ...
      console.error("[VenueEntryPageClubClone] Failed to submit withdrawal request:", err);
  ...
  const handleSendChallengerChatMessage = async () => {
    ...
    try {
      ...
      console.error("[VenueEntryPageClubClone] Failed sending challenger chat message:", err);
  ...
  const handleSendClubChatMessage = async () => {
    ...
    try {
      ...
      console.error("[VenueEntryPageClubClone] Failed sending club chat message:", err);
  ...
  const handleSetClubAdminPrivilege = async (shouldBeAdmin) => {
    ...
    try {
      ...
      console.error(
        "[VenueEntryPageClubClone] Failed updating club administrator privilege:",
        error
      );
      setAdminPrivilegesError(
  ...
  const collectMatchingDocumentRefs = async ({
    ...
    for (const [fieldName, fieldValue] of matches) {
      ...
      try {
        ...
        console.warn(
          `[VenueEntryPageClubClone] Could not query ${collectionName}.${fieldName}:`,
          error
        );
      }
    }
  ...
  const handleTerminateClubMembership = async () => {
    ...
    try {
      ...
      try {
        ...
        console.warn(
          "[VenueEntryPageClubClone] Could not queue squad cleanup:",
          cleanupStorageError
        );
      }
      ...
      console.error(
        "[VenueEntryPageClubClone] Failed terminating club membership:",
        error
      );
      setTerminationError(
  ...
  const handleCloseDepartureNotice = async (departureNotice) => {
    ...
    try {
      ...
      console.error("[VenueEntryPageClubClone] Failed acknowledging departure notice:", err);
  ...
  const handleSendFixtureDiscussionMessage = async () => {
    ...
    try {
      ...
      console.error("[VenueEntryPageClubClone] Failed sending fixture discussion message:", err);
  ...
  const handleAcceptFixtureAlternative = async (noticePayload) => {
    ...
    try {
      ...
      console.error("[VenueEntryPageClubClone] Failed accepting fixture alternative:", err);
  ...
  const handleContinueOriginalFixtureRequest = async (noticePayload) => {
    ...
    try {
      ...
      console.error("[VenueEntryPageClubClone] Failed continuing fixture request:", err);
  ...
  const handleAcceptFixtureChange = async (noticePayload) => {
    ...
    try {
      ...
      console.error("[VenueEntryPageClubClone] Failed accepting fixture change:", err);
  ...
  const handleSubmitFixtureAlternative = async () => {
    ...
    try {
      ...
      console.error("[VenueEntryPageClubClone] Failed sending alternative fixture suggestion:", err);
    ...
    if (notice.type === "challenge_cancelled") {
      ...
      if (noticeId) {
        try {
          ...
          console.error("[VenueEntryPageClubClone] Failed acknowledging challenge notice:", err);
  ...
  const handleAcceptChallenge = async (challenge) => {
    ...
    try {
      ...
      console.error("[VenueEntryPageClubClone] Failed accepting challenge:", err);
  ...
  const handleRejectChallenge = async (challenge) => {
    ...
    try {
      ...
      console.error("[VenueEntryPageClubClone] Failed rejecting challenge:", err);
