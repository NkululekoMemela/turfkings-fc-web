...
function buildChampionshipStarsByPlayer(mainSnap, canonicalMap, activeSeasonId) {
  ...
  seasons.forEach((season) => {
    ...
    // This lets one player show two, three, or more stars if they have
    // won multiple completed seasons.
  ...
  const playersWithRatings = useMemo(() => {
    ...
    allNames.forEach((canonName) => {
      ...
      out.push({
        ...
        gkCleanSheets: displayGkCleanSheets,
        defCleanSheets: displayDefCleanSheets,
